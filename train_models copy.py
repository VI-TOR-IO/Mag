...
# def train_lstm_multistep(model, train_loader, num_epochs=50, lr=0.001):
...
#                 y_batch = y_batch.squeeze() if y_batch.ndim == 2 and y_batch.shape[1] == 1 else y_batch
...
#         train_lstm_multistep(model, train_loader, num_epochs=25)
